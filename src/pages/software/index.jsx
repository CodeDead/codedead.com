            ...
            <Card style={{ height: '100%' }}>
              ...
              >
                <CardContent>
                  ...
                  <Typography color="textSecondary" paragraph>
                    Easily generate thousands of passwords using Advanced PassGen. You can even
                    go so far as to define your own character set!
                  </Typography>
                </CardContent>
              </CardActionArea>
            </Card>
              ...
              >
                <CardContent>
                  ...
                  <Typography color="textSecondary" paragraph>
                    ...
                    of charge! DeadPix can fix stuck or dead pixels by rapidly cycling the color
                    value of the pixel. Please note that this tool does not provide a 100% success
                    rate.
                  </Typography>
                </CardContent>
              </CardActionArea>
            ...
            <Card style={{ height: '100%' }}>
              ...
              >
                <CardContent>
                  ...
                  <Typography color="textSecondary" paragraph>
                    AniView is a free and open source GIF image viewer. You can watch GIF images
                    your way, thanks to all the options that are available in AniView.
                  </Typography>
                </CardContent>
              </CardActionArea>
            </Card>
