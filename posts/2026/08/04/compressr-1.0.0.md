---
path: '/blog/2026/08/04/compressr-1.0.0'
title: 'Compressr v1.0.0 Release'
author: 'CodeDead'
date: '2026-08-04'
abstract: 'Compressr v1.0.0 has been released! This is the desktop version of the Compressr website. It is a free, open-source image compression tool built with Rust and Iced. It supports JPEG, PNG, GIF, WebP, BMP, and TIFF...'
...
Compressr v1.0.0 has been released! This is the desktop version of the [Compressr](https://compressr.codedead.com) website. It is a free, open-source image compression tool built with Rust and Iced. It supports JPEG, PNG, GIF, WebP, BMP, and TIFF formats with batch processing, customizable quality, scaling, and EXIF metadata preservation across Windows, macOS, and Linux.
...
If you're curious to find out more, you can find the source code on [GitHub](https://github.com/CodeDead/compressr-app).
To download a prebuilt binary, please visit the [releases page](https://codedead.com/software/compressr/).
